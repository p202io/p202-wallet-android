...
public class QRExtractorTest {
    ...
    public void parseQRURLTest() {
        ...
        //Test magiclink
        result = parser.parse("https://rinkeby.p202w.app/AQAHoSBfnM-scRdqGWp_UEFOHl90fBDj0M9-ItcPWPUGu2LCYyzBDW7mt9VVyoPkHIk1ElL9xCQM90jeMiYJMYA4l4-JtVQ-UGijRcbFEaCZLSvSsCuXGpApc4zCehw=");
        assertTrue(result.type == EIP681Type.MAGIC_LINK);

        result = parser.parse("https://wallet.p202.io");
        System.out.println(result.getAddress());
        assertTrue(result.type == EIP681Type.URL);

        result = parser.parse("http://wallet.p202.io");
        System.out.println(result.getAddress());
        assertTrue(result.type == EIP681Type.URL);
    }
}